...
namespace ProgressTable.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public MainWindowViewModel()
        {
            ...
            {
                new Student{Name="Филиппов Георгий Артёмович", Visual=0, Architecture=0, Networks=1, Calculate_Math=1, PI=2, Math=2, Electric=1},
                new Student{Name="Архипова Дарья Богдановна", Visual=2, Architecture=0, Networks=2, Calculate_Math=1, PI=2, Math=1, Electric=1},
            };
            CheckAverage(students);
